    ...
    def update(self, pred, true): 
        ...
        if self.ignore_index is not None:
            if (true == self.ignore_index).sum() > 0:
                ...
                # NOTE: modify for self.ignore_index == 0
                pred[true == self.ignore_index] = self.ignore_index
        unique_mapping = true * self.virtual_num_classes + pred
        ...
        if self.ignore_index is None:
            ...
            self.value += bins.view(self.virtual_num_classes, self.virtual_num_classes)[(self.ignore_index+1):, (self.ignore_index+1):]
