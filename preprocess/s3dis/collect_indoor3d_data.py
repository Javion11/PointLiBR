...
from indoor3d_util import mkdir_or_exist, export

process_dir = "" # data directory

parser = argparse.ArgumentParser()
parser.add_argument(
    '--output-folder',
    default=process_dir+'raw',
    help='output folder of the result.')
parser.add_argument(
    '--data-dir',
    default=process_dir + 'Stanford3dDataset_v1.2_Aligned_Version',
    help='s3dis data directory.')
parser.add_argument(
    '--ann-file',
    default=process_dir + 'meta_data/anno_paths.txt',
